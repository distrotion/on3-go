...
// var server = "mongodb://127.0.0.1:9000"
...
func UpdatePushArraycusStr(ctx context.Context, db_mongo_u string, collec_u string, input1 bson.M, input2 string, input3 string) string {
